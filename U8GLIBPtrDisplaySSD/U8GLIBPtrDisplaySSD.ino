...
#define PAGEDELAY               1500     // Between Page delay .5 seconds .
...
const void (*ViewPages[])( U8GLIB_SSD1306_128X32 &U8_SSDInterface ) = { pageBoot, pageRPMShow, pageRPMInvert, pageDone } ;

const char *chPageMessage[] = { "Boot", 
...
{  
#ifdef USE_SERIAL_MSG
  Serial.println(String("Preparing ") + String( iIndexCount ) + String(" pages to show.") );
#endif
